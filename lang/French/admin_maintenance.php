...
'Rebuild completed info'		=>	'Une fois que le processus s\'est achevé vous serez redirigé vers cette page. Si vous êtes contraint(e) d\'interrompre le processus de reconstruction, notez l\'ID du message traité en dernier et indiquez la valeur ID+1 dans «&#160;ID du message de départ&#160;» lorsque/si vous souhaitez continuer («&#160;Effacer l\'index&#160;» ne doit pas être sélectionné).',
