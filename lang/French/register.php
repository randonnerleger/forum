...
'Registration errors info'	=>	'Les erreurs suivantes doivent être corrigées avant que vous puissiez vous inscrire&#160;:',
'Username censor'		=>	'Le nom d\'utilisateur que vous avez saisi contient des mots interdits. Veuillez choisir un autre nom d\'utilisateur.',
'Username dupe 1'		=>	'Il existe déjà une personne inscrite avec ce nom d\'utilisateur.',
'Username dupe 2'		=>	'Ce nom d\'utilisateur est trop ressemblant. Il doit différer par au moins un caractère alpha-numérique (a-z ou 0-9). Veuillez essayer un autre nom d\'utilisateur.',
'Email not match'		=>	'Les adresses électroniques ne coïncident pas. Veuillez revenir en arrière et corriger cela.',

// Registration e-mail stuff
'Reg email'			=>	'Merci de vous être inscrit(e). Votre mot de passe a été envoyé à l\'adresse indiquée. Si vous ne l\'obtenez pas, merci de contacter l\'administrateur&#160;:',
'Reg complete'			=>	'Inscription acceptée. Identification et redirection&#160;…',
...
'Pass info'			=>	'Le mot de passe doit comporter au minimum 6 caractères (sensible à la casse).',
...
//********************* Modif : Antibot
'Antispam info'            =>    'Afin de nous assurer que ce n\'est pas un robot spammeur qui tente de s\'inscrire : <ul><li>1. trouvez le mot clé de 4 lettres qui répond à cette question : "Qu\'est-ce qui est riche dans ce site ?" (la réponse se trouve dans les règles que vous venez d\'accepter)</li><li>2. <strong>pour que votre inscription soit acceptée faites précéder le <u>premier</u> e-mail ci-dessous du mot clé que vous venez de trouver. Exemple : MotCléVotreEmail@email.fr</strong></li></ul>',
//********************* Fin Modif
);
